...
#write catalogues of top quantiles

#closed/ac-
write.table(MPP_closed_unac_top_quantile, file='MPP_closed_unac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(CMP_closed_unac_top_quantile, file='CMP_closed_unac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(GMP_closed_unac_top_quantile, file='GMP_closed_unac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(B_cell_closed_unac_top_quantile, file='B_cell_closed_unac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Mono_closed_unac_top_quantile, file='Mono_closed_unac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Gran_closed_unac_top_quantile, file='Gran_closed_unac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
#closed/ac+
write.table(MPP_closed_ac_top_quantile, file='MPP_closed_ac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(CMP_closed_ac_top_quantile, file='CMP_closed_ac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(GMP_closed_ac_top_quantile, file='GMP_closed_ac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(B_cell_closed_ac_top_quantile, file='B_cell_closed_ac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Mono_closed_ac_top_quantile, file='Mono_closed_ac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Gran_closed_ac_top_quantile, file='Gran_closed_ac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
#open/ac-
write.table(MPP_open_unac_top_quantile, file='MPP_open_unac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(CMP_open_unac_top_quantile, file='CMP_open_unac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(GMP_open_unac_top_quantile, file='GMP_open_unac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(B_cell_open_unac_top_quantile, file='B_cell_open_unac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Mono_open_unac_top_quantile, file='Mono_open_unac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Gran_open_unac_top_quantile, file='Gran_open_unac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
#open/ac+
write.table(MPP_open_ac_top_quantile, file='MPP_open_ac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(CMP_open_ac_top_quantile, file='CMP_open_ac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(GMP_open_ac_top_quantile, file='GMP_open_ac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(B_cell_open_ac_top_quantile, file='B_cell_open_ac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Mono_open_ac_top_quantile, file='Mono_open_ac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Gran_open_ac_top_quantile, file='Gran_open_ac_top_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
...
#write catalogues of bottom quantiles

#closed/ac-
write.table(MPP_closed_unac_bottom_quantile, file='MPP_closed_unac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(CMP_closed_unac_bottom_quantile, file='CMP_closed_unac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(GMP_closed_unac_bottom_quantile, file='GMP_closed_unac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(B_cell_closed_unac_bottom_quantile, file='B_cell_closed_unac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Mono_closed_unac_bottom_quantile, file='Mono_closed_unac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Gran_closed_unac_bottom_quantile, file='Gran_closed_unac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
#closed/ac+
write.table(MPP_closed_ac_bottom_quantile, file='MPP_closed_ac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(CMP_closed_ac_bottom_quantile, file='CMP_closed_ac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(GMP_closed_ac_bottom_quantile, file='GMP_closed_ac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(B_cell_closed_ac_bottom_quantile, file='B_cell_closed_ac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Mono_closed_ac_bottom_quantile, file='Mono_closed_ac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Gran_closed_ac_bottom_quantile, file='Gran_closed_ac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
#open/ac-
write.table(MPP_open_unac_bottom_quantile, file='MPP_open_unac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(CMP_open_unac_bottom_quantile, file='CMP_open_unac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(GMP_open_unac_bottom_quantile, file='GMP_open_unac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(B_cell_open_unac_bottom_quantile, file='B_cell_open_unac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Mono_open_unac_bottom_quantile, file='Mono_open_unac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Gran_open_unac_bottom_quantile, file='Gran_open_unac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
#open/ac+
write.table(MPP_open_ac_bottom_quantile, file='MPP_open_ac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(CMP_open_ac_bottom_quantile, file='CMP_open_ac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(GMP_open_ac_bottom_quantile, file='GMP_open_ac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(B_cell_open_ac_bottom_quantile, file='B_cell_open_ac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Mono_open_ac_bottom_quantile, file='Mono_open_ac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
write.table(Gran_open_ac_bottom_quantile, file='Gran_open_ac_bottom_quantile_gene_catalogue.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE)
...
#extract genes from GO runs of interest
...
GO_MPP_closed_ac_top_quantile <- {
  ...
  GO_genes_1 <- (geneIdsByCategory(GO_run)[["GO:2000134"]])
  GO_genes_2 <- (geneIdsByCategory(GO_run)[["GO:1902807"]])
  GO_genes_3 <- (geneIdsByCategory(GO_run)[["GO:0044843"]])
  GO_genes_4 <- (geneIdsByCategory(GO_run)[["GO:1901987"]])
  GO_genes_5 <- (geneIdsByCategory(GO_run)[["GO:1902806"]])
  
  ENTREZ <- vctrs::vec_c(GO_genes_1, GO_genes_2, GO_genes_3, GO_genes_4, GO_genes_5)
  ENTREZ_table <- as.data.frame(ENTREZ)
  ENTREZ_table_annotated <- merge(ENTREZ_table, enhancers_and_genes, by.x = TRUE, by="ENTREZ") %>%
   unique()
  write.table(ENTREZ_table_annotated, file='MPP_closed_ac_top_quantile_GO_genes_cell_cycle.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE) 
...
GO_CMP_closed_ac_top_quantile <- {
  ...
  GO_genes_1 <- (geneIdsByCategory(GO_run)[["GO:0071158"]])
  GO_genes_2 <- (geneIdsByCategory(GO_run)[["GO:0031571"]])
  GO_genes_3 <- (geneIdsByCategory(GO_run)[["GO:0044783"]])
  GO_genes_4 <- (geneIdsByCategory(GO_run)[["GO:0044773"]])
  GO_genes_5 <- (geneIdsByCategory(GO_run)[["GO:0044774"]])
  GO_genes_6 <- (geneIdsByCategory(GO_run)[["GO:0044819"]])
  GO_genes_7 <- (geneIdsByCategory(GO_run)[["GO:1901991"]])
  
  ENTREZ <- vctrs::vec_c(GO_genes_1, GO_genes_2, GO_genes_3, GO_genes_4, GO_genes_5, GO_genes_6, GO_genes_7)
  ENTREZ_table <- as.data.frame(ENTREZ)
  ENTREZ_table_annotated <- merge(ENTREZ_table, enhancers_and_genes, by.x = TRUE, by="ENTREZ") %>%
    unique()
  write.table(ENTREZ_table_annotated, file='CMP_closed_ac_top_quantile_GO_genes_cell_cycle.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE) 
...
GO_Mono_closed_ac <- {
  ...
  GO_genes_1 <- (geneIdsByCategory(GO_run)[["GO:0097198"]])
  GO_genes_2 <- (geneIdsByCategory(GO_run)[["GO:0016573"]])
  GO_genes_3 <- (geneIdsByCategory(GO_run)[["GO:0010452"]])
  GO_genes_4 <- (geneIdsByCategory(GO_run)[["GO:0043983"]])
  GO_genes_5 <- (geneIdsByCategory(GO_run)[["GO:0043981"]])
  GO_genes_6 <- (geneIdsByCategory(GO_run)[["GO:0043982"]])
  
  ENTREZ <- vctrs::vec_c(GO_genes_1, GO_genes_2, GO_genes_3, GO_genes_4, GO_genes_5, GO_genes_6)
  ENTREZ_table <- as.data.frame(ENTREZ)
  ENTREZ_table_annotated <- merge(ENTREZ_table, enhancers_and_genes, by.x = TRUE, by="ENTREZ") %>%
    unique()
  write.table(ENTREZ_table_annotated, file='Mono_closed_ac_GO_genes_histones.tsv', quote=FALSE, sep='\t', row.names = FALSE, col.names = TRUE) 
